...
#[doc = ""]
#[doc = " The H3Index fits within a 64-bit unsigned integer."]
...
fn bindgen_test_layout_LatLng() {
    ...
    fn test_field_lat() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<LatLng>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).lat) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_CellBoundary() {
    ...
    fn test_field_numVerts() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<CellBoundary>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numVerts) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_verts() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<CellBoundary>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).verts) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
...
#[doc = " @struct GeoLoop"]
#[doc = "  @brief similar to CellBoundary, but requires more alloc work"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GeoLoop {
    pub numVerts: ::std::os::raw::c_int,
...
fn bindgen_test_layout_GeoLoop() {
    ...
    fn test_field_numVerts() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoLoop>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numVerts) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_GeoPolygon() {
    ...
    fn test_field_geoloop() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).geoloop) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_geoloop();
    fn test_field_numHoles() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numHoles) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_holes() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).holes) as usize - ptr as usize
            },
            24usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_GeoMultiPolygon() {
    ...
    fn test_field_numPolygons() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoMultiPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numPolygons) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_numPolygons();
    fn test_field_polygons() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GeoMultiPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).polygons) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_LinkedLatLng() {
    ...
    fn test_field_vertex() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<LinkedLatLng>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_LinkedGeoLoop() {
    ...
    fn test_field_first() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<LinkedGeoLoop>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_LinkedGeoPolygon() {
    ...
    fn test_field_first() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<LinkedGeoPolygon>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).first) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_CoordIJ() {
    ...
    fn test_field_i() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<CoordIJ>::uninit();
                let ptr = uninit.as_ptr();
...
extern "C" {
    pub fn h3ToString(h: H3Index, str_: *mut ::std::os::raw::c_char, sz: size_t) -> H3Error;
}
extern "C" {
